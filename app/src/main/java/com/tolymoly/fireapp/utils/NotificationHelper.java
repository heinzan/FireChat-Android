...
import com.tolymoly.fireapp.activities.MainActivity;
...
import com.tolymoly.fireapp.receivers.HandleReplyReceiver;
import com.tolymoly.fireapp.receivers.MarkAsReadReceiver;
            ...
            if (last7UnreadMessages.isEmpty()) {
                ...
                for (int i = 0; i < last7UnreadMessages.size(); i++) {
                    ...
                    if (isNotificationsEnabled && !chat.isMuted()) {
                        ...
                        messagingStyle.addMessage(MessageTypeHelper.getMessageContent(unreadMessage, true), Long.parseLong(unreadMessage.getTimestamp()), sender);
            ...
            for (Chat unreadChat : unreadChats) {
                ...
                if (isNotificationsEnabled && !unreadChat.isMuted()) {
                    ...
                    if (isGroup) {
                        ...
                        for (Message unreadMessage : messageList) {
                            inboxStyle.addLine(MessageTypeHelper.getMessageContent(unreadMessage, true));
                        }
                    }
                    ...
                    NotificationCompat.Builder notificationBuilder =
                            createNotificationBuilder(
                                    ...
                                    , MessageTypeHelper.getMessageContent(unreadChat.getUnreadMessages().last(), true)
