...
import com.tolymoly.fireapp.model.realms.UnUpdatedStat;
import com.tolymoly.fireapp.model.realms.UnUpdatedVoiceMessageStat;
...
*/
    ...
    public void saveStatus(String userId, Status status) {
        ...
        if (userStatuses == null) {
            ...
            userStatuses.getStatuses().add(status);
