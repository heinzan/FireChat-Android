package com.tolymoly.fireapp.views;
...
import com.tolymoly.fireapp.adapters.PartialGroupUsersAdapter;
...
public class AcceptInviteBottomSheet extends BottomSheetDialogFragment {
    ...
    public void showData(User user, int usersCount) {
        ...
        com.tolymoly.fireapp.model.realms.Group group = user.getGroup();
        if (group != null) {
